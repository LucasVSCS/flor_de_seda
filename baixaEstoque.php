...
<head>
    ...
    <title>Painel | Baixa de produtos</title>
    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Baixa no estoque</span></li>
            </ol>
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="listenSlider" type="hidden" name="valorSaida" value="50" />
                        </div>
                ...
                <div class="col-md-6 col-md-offset-5">
                    <input type="submit" name="baixa" class="mb-xs mt-xs mr-xs btn btn-primary" value="Realizar baixa">
