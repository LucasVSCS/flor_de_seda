...
<head>
    ...
    <title>Painel | Visualizar Clientes</title>
...
<body>
    <section class="body">
            ...
            <section role="main" class="content-body">
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Visualizar Clientes Registrados</span></li>
                ...
                <section class="panel">
                   <header class="panel-heading">
                     ...
                     <h2 class="panel-title">Clientes Registrados</h2>
                 </header>
      ...
      <section class="panel">
          <div class="panel-body">
            <form action="controller/Cliente/clienteController.php" method="GET">
...
?>
                ...
                <a href="controller/Cliente/clienteController.php"><button name="editar">Editar</button> <a>
                    <a href="controller/Cliente/clienteController.php"><button name="excluir">Excluir</button> <a>
                    </div>
...
<script src="assets/ajax/ajaxClientes.js"></script>
