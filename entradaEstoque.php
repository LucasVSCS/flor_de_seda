...
<head>
    ...
    <title>Painel | Entrada de produtos</title>
    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Entrada de produtos</span></li>
            </ol>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Selecionar produto e Quantidade</h2>
                </header>
                <div class="panel-body">
                    <form class="form-horizontal form-bordered" method="GET" action="controller/Estoque/estoqueController.php">

                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputSuccess">Selecionar produto</label>
                            <div class="col-md-6">
                                <select class="form-control mb-md" name="id">
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="m-md slider-primary" data-plugin-slider data-plugin-options='{ "value": 50, "range": "min", "max": 500 }'
                                data-plugin-slider-output="#listenSlider">
                                <input id="listenSlider" type="hidden" name="valorEntrada" value="50" />
                            </div>
                            <p class="output">Quantidade atual: <b>50</b></p>
                        </div>
                    </div>

                    <div class="col-md-6 col-md-offset-5">
                        <input type="submit" name="entrada" class="mb-xs mt-xs mr-xs btn btn-primary" value="Dar entrada">
