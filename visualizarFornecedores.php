...
<head>
    ...
    <title>Painel | Visualizar Fornecedores</title>
...
<body>
    <section class="body">
            ...
            <section role="main" class="content-body">
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Gerenciar Fornecedores</span></li>
                            <li><span>Visualizar Fornecedores Registrados</span></li>
                ...
                <section class="panel">
                   <header class="panel-heading">
                     ...
                     <h2 class="panel-title">Fornecedores Registrados</h2>
                 </header>
      ...
      <section class="panel">
          <div class="panel-body">
            <form action="controller/Fornecedor/fornecedorController.php" method="GET">
...
?>
                ...
                <a href="controller/Fornecedor/fornecedorController.php"><button name="editar">Editar</button> <a>
                    <a href="controller/Fornecedor/fornecedorController.php"><button name="excluir">Excluir</button> <a>
                    </div>
...
<script src="assets/ajax/ajaxFornecedores.js"></script>
