...
<head>
	...
	<title>Painel | Editar Funcionário</title>
		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<h2><?php echo "Editar dados do cliente " . $nome; ?></h2>
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Gerenciar Funcionários</span></li>
							<li><span>Editar Funcionário</span></li>
						</ol>
					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Dados do Funcionário</h2>
							</header>
							<div class="panel-body">
								<form class="form-horizontal form-bordered" method="POST" action="controller/Funcionario/funcionarioController.php">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<input type="text" name="salario" class="form-control" id="salario" value="<?php echo $salario; ?>">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<input type="text" name="telefone" class="form-control" id="telefone" data-plugin-masked-input data-input-mask="(99)99999-9999" placeholder="(__)_____-____" value="<?php echo $telefone; ?>">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<input type="text" name="mail" class="form-control" id="mail" value="<?php echo $email; ?>">
											</div>
										</div>
									</div>

									<div class="form-group">
										<label class="col-md-3 control-label" for="inputSuccess">Nivel de acesso</label>
										<div class="col-md-6">
											<select class="form-control mb-md" name="nivelAcesso">
