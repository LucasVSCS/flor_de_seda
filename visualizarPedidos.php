...
<head>
    ...
    <title>Painel | Visualizar Pedidos</title>
    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Visualizar Pedidos</span></li>
      ...
      <div class="table-responsive">
         <table class="table mb-none">
            <thead>
               <tr>
                  <th>#</th>
                  <th>ID do Cliente solicitante</th>
                  <th>ID do Funcionário vendedor</th>
                  <th>ID do Produto vendido</th>
                  <th>Quantidade do produto vendido</th>
...
<section class="panel">
  <div class="panel-body">
    <form action="controller/Pedido/pedidoController.php" method="GET">
        <div class="form-group">
            <h2 class="panel-title"><p class="text-center" style="font-size:20px;">Editar ou excluir um registro</p></h2>
            ...
            <div class="col-md-6 col-md-offset-3">
             <select name="id" class="form-control mb-md" required>
                ...
                $qryLista = mysqli_query($con, "SELECT idPedidos, descricao FROM pedidos");
                while ($dados = mysqli_fetch_assoc($qryLista)) {
                    echo '<option value="' . $dados["idPedidos"] . '">' . $dados["idPedidos"] . ' - ' . $dados["descricao"] . '</option>';
                }
                mysqli_close($con);
                ?>
            </select>
        </div>
        <a href="controller/Funcionarios/funcionarioController.php"><button name="excluir">Excluir</button> <a>
        </div>
...
<script src="assets/ajax/ajaxPedidos.js"></script>
