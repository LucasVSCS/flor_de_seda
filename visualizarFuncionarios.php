...
<head>
    ...
    <title>Painel | Visualizar Funcionarios</title>
...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Gerenciar Funcionarios</span></li>
                <li><span>Visualizar Funcionarios Registrados</span></li>
   ...
   <h2 class="panel-title">Funcionarios Registrados</h2>
</header>
...
<section class="panel">
  <div class="panel-body">
    <form action="controller/Funcionario/funcionarioController.php" method="GET">
        ...
        <a href="controller/Funcionarios/funcionarioController.php"><button name="editar">Editar</button> <a>
...
<script src="assets/ajax/ajaxFuncionarios.js"></script>
