...
<head>
    ...
    <title>Painel | Cadastro de Funcionários</title>
                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Gerenciar Funcionário</span></li>
                            <li><span>Cadastrar Funcionário</span></li>
                        </ol>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="telefone" class="form-control" id="telefone" data-plugin-masked-input data-input-mask="(99)99999-9999" placeholder="(__)_____-____">
                                        </div>
                                    </div>
                                </div>
