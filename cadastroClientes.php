...
<head>
	...
	<title>Painel | Cadastro de Clientes</title>
				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Cadastrar Clientes</span></li>
						</ol>
					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								<form class="form-horizontal form-bordered" method="POST" action="controller/Cliente/clienteController.php">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<input type="text" name="cnpj" class="form-control" id="cnpj" placeholder="__.___.___/____-__" required>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<input type="text" name="foneUm" class="form-control" id="foneUm" data-plugin-masked-input data-input-mask="(99)99999-9999" placeholder="(__)_____-____" required>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<input type="text" name="foneDois" class="form-control" id="foneDois" data-plugin-masked-input data-input-mask="(99)99999-9999" placeholder="(__)_____-____" required>
											</div>
										</div>
									</div>
